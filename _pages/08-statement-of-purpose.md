...
This is also a great place to show off your research soft skills: Have you mentored newer undergraduates in the lab and learned important lessons about effective mentor/mentee communication? Have different experiences taught you the importance of diligent documentation? All of these are green flags to potential PIs! Although it's okay to mention hard skills, try to highlight these types of softer skills in your SOP that are not as self-evident from your CV and/or the research you conducted (eg. "By building a library of Python codes to analyze my simulations, I gained proficiency in using Python for data analysis" is redundant and a missed opportunity).
